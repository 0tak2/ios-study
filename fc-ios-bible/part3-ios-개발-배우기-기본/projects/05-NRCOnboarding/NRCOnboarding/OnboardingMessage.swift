...
extension OnboardingMessage {
    static let messages: [OnboardingMessage] = [
        ...
        OnboardingMessage(imageName: "img_nike_achievement", title: "CHALLENGE YOURSELF", description: "Set new goals, break personal records, and discover your true potential with our motivational tracking and community support."),
    ]
